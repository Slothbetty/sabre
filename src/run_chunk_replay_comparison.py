#!/usr/bin/env python3
"""
Pipeline 2 — Chunk-replay ABR comparison runner.
...
All generated inputs and results are written to chunk_replay/.

Usage:
    python run_chunk_replay_comparison.py --index 0
    python run_chunk_replay_comparison.py --video-id Qg9LxRHLbAk
    python run_chunk_replay_comparison.py --index 4 --bandwidth-mean 2000 --bandwidth-std 500
...
CHUNKS_DIR  = SCRIPT_DIR / "chunk_replay"

DEFAULT_CHUNKS         = "chunk_replay/chunks_1_200.json"
...
def main():
    ...
    print("\nDone. Load chunk_replay/results/comparison_summary.json in the viewer.")
